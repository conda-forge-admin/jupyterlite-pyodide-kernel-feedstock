...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyterlite-pyodide-kernel-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyterlite-pyodide-kernel-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyterlite-pyodide-kernel jupyterlite-pyodide-kernel-with-lock
# for installing globally
pixi global install jupyterlite-pyodide-kernel jupyterlite-pyodide-kernel-with-lock
```
...
It is possible to list all of the versions of `jupyterlite-pyodide-kernel` available on your platform:
...
```
pixi search jupyterlite-pyodide-kernel --channel conda-forge
```
